...
class HizbulVikayeCuma extends StatefulWidget {
  @override
  _HizbulVikayeCumaState createState() => _HizbulVikayeCumaState();
}

class _HizbulVikayeCumaState extends State<HizbulVikayeCuma>
    with SingleTickerProviderStateMixin {
  List<String> esmaulHusnaImages = [
    "278.jpg",
    "279.jpg",
    "280.jpg",
    "281.jpg",
  ...
  List<String> esmaulHusnaImagesNumber = [
    "278",
    "279",
    "280",
    "281",
                ...
                _firstSearch
                    ? Expanded(
                        child: PageView.builder(
                          ...
                          itemCount: esmaulHusnaImages.length, // ***
                          scrollDirection: Axis.horizontal, //Alp1071
                          itemBuilder: (context, index) {
                            final item = esmaulHusnaAudio[index];
                            return Column(
                              children: [
                                Expanded(
                                  flex: 8,
                                      ...
                                      child: ClipRect(
                                        child: PhotoView.customChild(
                                          ...
                                          child: Container(
                                            ...
                                            child: Image.asset(
                                              "assets/${esmaulHusnaImages[index]}",
                                              height: 250.0,
                                            ),
                                          ),
                                        ),
                                  ...
                                  child: PlayerBuilder.isPlaying(
                                    ...
                                    builder: (context, isPlaying) {
                                      return PlayingControls(
                                        pageNumber:
                                            "${esmaulHusnaImagesNumber[index]} / 283",
                                        isPlaying: isPlaying,
                                        isPlaylist: true,
                                        onPlay: () {
