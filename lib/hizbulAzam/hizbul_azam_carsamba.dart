...
class HizbulAzamCarsamba extends StatefulWidget {
  @override
  _HizbulAzamCarsambaState createState() => _HizbulAzamCarsambaState();
}

class _HizbulAzamCarsambaState extends State<HizbulAzamCarsamba>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Hizbul Azam Çarşamba"),
