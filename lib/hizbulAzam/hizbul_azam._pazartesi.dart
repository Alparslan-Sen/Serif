...
class HizbulAzamPazartesi extends StatefulWidget {
  @override
  _HizbulAzamPazartesiState createState() => _HizbulAzamPazartesiState();
}

class _HizbulAzamPazartesiState extends State<HizbulAzamPazartesi>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Hizbul Azam Pazartesi"),
