...
class HizbulAzamCumartesi extends StatefulWidget {
  @override
  _HizbulAzamCumartesiState createState() => _HizbulAzamCumartesiState();
}

class _HizbulAzamCumartesiState extends State<HizbulAzamCumartesi>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Hizbul Azam Cumartesi"),
