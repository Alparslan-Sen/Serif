...
class HizbulAzamPersembe extends StatefulWidget {
  @override
  _HizbulAzamPersembeState createState() => _HizbulAzamPersembeState();
}

class _HizbulAzamPersembeState extends State<HizbulAzamPersembe>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Hizbul Azam Perşembe"),
