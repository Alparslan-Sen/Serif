...
class UcGundeHatimBirinciKisim extends StatefulWidget {
  @override
  _UcGundeHatimBirinciKisimState createState() =>
      _UcGundeHatimBirinciKisimState();
}

class _UcGundeHatimBirinciKisimState extends State<UcGundeHatimBirinciKisim>
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 85", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
