...
class UcGundeHatimIkinciKisim extends StatefulWidget {
  @override
  _UcGundeHatimIkinciKisimState createState() =>
      _UcGundeHatimIkinciKisimState();
}

class _UcGundeHatimIkinciKisimState extends State<UcGundeHatimIkinciKisim>
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 122", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
