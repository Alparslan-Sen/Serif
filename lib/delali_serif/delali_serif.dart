...
class DelaliSerif extends StatefulWidget {
  @override
  _DelaliSerifState createState() => _DelaliSerifState();
}

class _DelaliSerifState extends State<DelaliSerif>
          ...
          return Column(
            children: [
              Expanded(
                ...
                child: GestureDetector(
                  onTap: () async {
                    print("item ne geldi = " + item.toString());
                    try {
                      await _assetsAudioPlayer.open(
                        item,
                        autoStart: true,
