...
class HatimDuasi extends StatefulWidget {
  @override
  _HatimDuasiState createState() => _HatimDuasiState();
}

class _HatimDuasiState extends State<HatimDuasi>
    with SingleTickerProviderStateMixin {
  String title = "Hatim Duası"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 161", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
