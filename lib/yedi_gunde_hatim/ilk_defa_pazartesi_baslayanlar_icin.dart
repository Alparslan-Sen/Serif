...
class IlkDefaBaslayanlarIcin extends StatefulWidget {
  @override
  _IlkDefaBaslayanlarIcinState createState() => _IlkDefaBaslayanlarIcinState();
}

class _IlkDefaBaslayanlarIcinState extends State<IlkDefaBaslayanlarIcin>
    with SingleTickerProviderStateMixin {
  String title = ""; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 157", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
