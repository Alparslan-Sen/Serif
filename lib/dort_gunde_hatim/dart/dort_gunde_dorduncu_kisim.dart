...
class DortGundeHatimDorduncuKisim extends StatefulWidget {
  @override
  _DortGundeHatimDorduncuKisimState createState() =>
      _DortGundeHatimDorduncuKisimState();
}

class _DortGundeHatimDorduncuKisimState
    extends State<DortGundeHatimDorduncuKisim>
    with SingleTickerProviderStateMixin {
  String title = "4. Kısım"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 151", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
