...
class DortGundeHatimBirinciKisim extends StatefulWidget {
  @override
  _DortGundeHatimBirinciKisimState createState() =>
      _DortGundeHatimBirinciKisimState();
}

class _DortGundeHatimBirinciKisimState extends State<DortGundeHatimBirinciKisim>
    with SingleTickerProviderStateMixin {
  String title = "1. Kısım"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 77", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
