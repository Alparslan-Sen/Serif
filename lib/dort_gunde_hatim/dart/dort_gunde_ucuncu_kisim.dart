...
class DortGundeHatimUcuncuKisim extends StatefulWidget {
  @override
  _DortGundeHatimUcuncuKisimState createState() =>
      _DortGundeHatimUcuncuKisimState();
}

class _DortGundeHatimUcuncuKisimState extends State<DortGundeHatimUcuncuKisim>
    with SingleTickerProviderStateMixin {
  String title = "3. Kısım"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 130", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
