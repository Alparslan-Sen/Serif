...
class DortGundeHatimIkinciKisim extends StatefulWidget {
  @override
  _DortGundeHatimIkinciKisimState createState() =>
      _DortGundeHatimIkinciKisimState();
}

class _DortGundeHatimIkinciKisimState extends State<DortGundeHatimIkinciKisim>
    with SingleTickerProviderStateMixin {
  String title = "2. Kısım"; // Buradan başlık değişiyor
