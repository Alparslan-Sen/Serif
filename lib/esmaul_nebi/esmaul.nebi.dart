...
class EsmaulNebi extends StatefulWidget {
  @override
  _EsmaulNebiState createState() => _EsmaulNebiState();
}

class _EsmaulNebiState extends State<EsmaulNebi>
    with SingleTickerProviderStateMixin {
  String title = "Esmaül-Nebi"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 49", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
