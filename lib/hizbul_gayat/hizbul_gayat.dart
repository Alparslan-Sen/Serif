...
class HizbulGayatIcerik extends StatefulWidget {
  @override
  _HizbulGayatIcerikState createState() => _HizbulGayatIcerikState();
}

class _HizbulGayatIcerikState extends State<HizbulGayatIcerik>
                                  ...
                                  child: PlayerBuilder.isPlaying(
                                    ...
                                    builder: (context, isPlaying) {
                                      return PlayingControls(
                                        pageNumber:
                                            "${esmaulHusnaImagesNumber[index]} / 287",
                                        isPlaying: isPlaying,
                                        isPlaylist: true,
                                        onPlay: () {
