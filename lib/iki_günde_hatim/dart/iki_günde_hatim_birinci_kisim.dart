...
class IkiGundeHatimBirinciKisim extends StatefulWidget {
  @override
  _IkiGundeHatimBirinciKisimState createState() =>
      _IkiGundeHatimBirinciKisimState();
}

class _IkiGundeHatimBirinciKisimState extends State<IkiGundeHatimBirinciKisim>
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 101", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
