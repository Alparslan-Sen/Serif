...
class IstigfaratSali extends StatefulWidget {
  @override
  _IstigfaratSaliState createState() => _IstigfaratSaliState();
}

class _IstigfaratSaliState extends State<IstigfaratSali>
    with SingleTickerProviderStateMixin {
  String title = "Salı İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 270", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
