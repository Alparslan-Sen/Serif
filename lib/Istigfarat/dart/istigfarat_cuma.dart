...
class IstigfaratCuma extends StatefulWidget {
  @override
  _IstigfaratCumaState createState() => _IstigfaratCumaState();
}

class _IstigfaratCumaState extends State<IstigfaratCuma>
    with SingleTickerProviderStateMixin {
  String title = "Cuma İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 255", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
