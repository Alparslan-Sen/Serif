...
class IstigfaratPazar extends StatefulWidget {
  @override
  _IstigfaratPazarState createState() => _IstigfaratPazarState();
}

class _IstigfaratPazarState extends State<IstigfaratPazar>
    with SingleTickerProviderStateMixin {
  String title = "Pazar İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 263", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
