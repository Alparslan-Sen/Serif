...
class IstigfaratCumartesi extends StatefulWidget {
  @override
  _IstigfaratCumartesiState createState() => _IstigfaratCumartesiState();
}

class _IstigfaratCumartesiState extends State<IstigfaratCumartesi>
    with SingleTickerProviderStateMixin {
  String title = "Cumartesi İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 259", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
