...
class IstigfaratPersembe extends StatefulWidget {
  @override
  _IstigfaratPersembeState createState() => _IstigfaratPersembeState();
}

class _IstigfaratPersembeState extends State<IstigfaratPersembe>
    with SingleTickerProviderStateMixin {
  String title = "Perşembe İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 277", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
