...
class IstigfaratPazartesi extends StatefulWidget {
  @override
  _IstigfaratPazartesiState createState() => _IstigfaratPazartesiState();
}

class _IstigfaratPazartesiState extends State<IstigfaratPazartesi>
    with SingleTickerProviderStateMixin {
  String title = "Pazartesi İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 267", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
