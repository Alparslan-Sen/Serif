...
class IstigfaratCarsamba extends StatefulWidget {
  @override
  _IstigfaratCarsambaState createState() => _IstigfaratCarsambaState();
}

class _IstigfaratCarsambaState extends State<IstigfaratCarsamba>
    with SingleTickerProviderStateMixin {
  String title = "Çarşamba İstiğfarı"; // Buradan başlık değişiyor
            ...
            children: [
              ...
              Expanded(
                child: PlayerBuilder.isPlaying(
                  ...
                  builder: (context, isPlaying) {
                    return PlayingControls(
                      pageNumber: "${imagesNumber[index]} / 272", // ***
                      isPlaying: isPlaying,
                      isPlaylist: true,
                      onPlay: () {
                        _assetsAudioPlayer.playOrPause();
